...
class Combat:
    def __init__(self): 
        self.temproll = 0 #placeholder all dice rolls

    def roll_20(self): #O(1) Time complexity for best and worst-case
        # A 20 sided dice for damage calculations
        self.temproll = random.randint(1,20)

    def roll_6(self): #O(1) Time complexity for best and worst-case
        # A 6 sided dice to determine move order for the fight
    ...
    def item_use(self, item_type, damage_or_heal):
        ...
        #O(1) Time complexity for best and worst-case
        if item_type == "weapon":
    ...
    def damage_calculation(self, weapon): # The damage calculations to determine how much damage the player will do
        ...
        #All of these in the if and elif statements are O(1) for best and worst-case
    ...
    def turn_order(self): # Determines the move order based on the 6 sided dice
        ...
        #O(1) Time complexity for best and worst-case but could go on infinitely if the player and enemy's roll equal each other infinitely
        while first is None:
...
class Looting:
    ...
    def roll_100(self): #O(1) Time complexity for best and worst-case
        #A 100 sided dice to make rarities easier to distinguish
        roll = random.randint(1,100)
        return roll

    def enemy_coin_drop(self):#O(1) Time complexity for best and worst-case
        self.coins += 50
        return self.coins

    #What loot any enemy will drop after defeat
    def enemy_drop(self):#O(1) Time complexity for best and worst-case
...
class Shop:
    def __init__(self, hero_coins, inventory):
        ...
        if first_time == True:
            ...
            print("Welcome to the Shop traveler! Here you can buy potions and sell any extra weapons you come across!")
            first_time = False
        ...
        #O(1) Time complexity for best and worst-case unless the player decides they never want to leave the shop, in that case it is infinite
        while stay == True:
            option = input("----------------------------------------------------\n"
    ...
    def buy(self):#O(1) Time complexity for best and worst-case
    ...
    def sell(self): #O(n) for best and worst-case, checks each item in the inventory which could be a lot of items or no items
        print("----------------------------------------------------")
